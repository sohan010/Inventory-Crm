                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <div class="d-flex justify-content-between">
                            <div class="left">
                                <h3 class="card-title"><?php echo e(__('Country List')); ?></h3>
                            </div>
                            <div class="right">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('country-create')): ?>
                                    <div class="btn-wrapper">
                                        <a href="" data-toggle="modal" data-target="#new_country"
...
<?php endif; ?>
                                ...
                                <tbody>
                                <?php $__currentLoopData = $all_countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('country-edit')): ?>
                                                <a href="#"
                                                   data-toggle="modal"
                                                   data-target="#country_item_edit_modal"
                                                   class="btn btn-outline-primary btn-xs mb-3 mr-1 country_edit_btn"
 ...
 <?php $__env->startSection('script'); ?>
     <?php echo $__env->make('backend.popup-modals.country.add', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
     <?php echo $__env->make('backend.popup-modals.country.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
            $(document).ready(function () {
                $(document).on('click', '.country_edit_btn', function () {
                    ...
                    var form = $('#country_edit_modal_form');
                    form.attr('action', action);
                    form.find('#country_id').val(id);
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\xampp\htdocs\inventory-crm\@core\resources\views/backend/pages/others/country-settings.blade.php ENDPATH**/ ?>