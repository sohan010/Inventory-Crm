                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="right">
                                <a href="<?php echo e(route('admin.role.new')); ?>" class="btn btn-info"><?php echo e(__("New Role")); ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
...
<?php endif; ?>
                                                        <?php else: ?>
                                                            <span class="alert alert-warning"><?php echo e(__('Super admin has all access')); ?></span>
                                                        <?php endif; ?>
                                                    </td>
                                                </tr>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\xampp\htdocs\inventory-crm\@core\resources\views/backend/admin-role-manage/role/index.blade.php ENDPATH**/ ?>