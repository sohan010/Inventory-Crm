...
<head>
    ...
    <link href="<?php echo e(asset('assets/backend/css/colors/blue.cs')); ?>s" id="theme" rel="stylesheet">
     ...
     <link rel="stylesheet" href="<?php echo e(asset('assets/backend/xgenious/css/style.css')); ?>" >
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.preloader.css','data' => []]); ?>
<?php $component->withName('preloader.css'); ?>
...
<div id="main-wrapper">
        ...
        <nav class="navbar top-navbar navbar-expand-md navbar-light">
            ...
            <div class="navbar-header">
                <a class="navbar-brand" href="index.html">
                        ...
                        <img src="<?php echo e(asset('assets/backend/assets/images/logo-icon.png')); ?>" alt="homepage" class="dark-logo" />

                        <img src="<?php echo e(asset('assets/backend/assets/images/logo-light-icon.png')); ?>" alt="homepage" class="light-logo" />
                    </b>

                    <!-- Logo text --><span>
                         <!-- dark Logo text -->
                         <img src="<?php echo e(asset('assets/backend/assets/images/logo-text.png')); ?>" alt="homepage" class="dark-logo" />
                        <!-- Light Logo text -->
                         <img src="<?php echo e(asset('assets/backend/assets/images/logo-light-text.png')); ?>" class="light-logo" alt="homepage" /></span> </a>
            </div>
            ...
            <div class="navbar-collapse">
                ...
                <ul class="navbar-nav my-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="<?php echo e(route('admin.pos')); ?>" data-toggle="dropdown"
                                ...
                                <li>
                                    <div class="dw-user-box">
                                        ...
                                        <div class="u-text">
                                            ...
                                            <a href="#!" class="btn btn-rounded btn-danger btn-sm"><?php echo e(__('View Profile')); ?></a>
                                        </div>
                                    </div>
                                </li>
                                <li role="separator" class="divider"></li>
                                <li><a href="<?php echo e(route('admin.profile.update')); ?>"><i class="ti-user"></i> <?php echo e(__('Edit Profile')); ?></a></li>
                                <li><a href="<?php echo e(route('admin.password.change')); ?>"><i class="ti-wallet"></i> <?php echo e(__('Password Change')); ?></a></li>
                                <li><a href="<?php echo e(route('admin.logout')); ?>"><i class="fa fa-power-off"></i> <?php echo e(__('Logout')); ?></a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-4">
                <h3 class="text-themecolor"><span class="text-dark"><?php echo e(__('Today :')); ?></span> <?php echo e(\Carbon\Carbon::today()->format('d-m-Y')); ?> (<?php echo e(\Carbon\Carbon::today()->isoFormat('dddd')); ?>)</h3>
            </div>
            <div class="col-md-4 align-self-center">
                <ol class="breadcrumb">
        ...
        <footer class="footer">  <?php echo render_footer_copyright_text(); ?></footer>
    </div>
...
<script src="<?php echo e(asset('assets/backend/js/SohanCustom.js')); ?>"></script>
...
</html><?php /**PATH H:\xampp\htdocs\inventory-crm\@core\resources\views/backend/admin-master.blade.php ENDPATH**/ ?>