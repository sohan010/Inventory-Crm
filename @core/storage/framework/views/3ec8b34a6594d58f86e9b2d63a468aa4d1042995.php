                ...
                'event-settings'
                    ...
                    <li class="main_dropdown <?php if(request()->is('admin-home/form-builder/*')): ?> active <?php endif; ?>">
                        ...
                        <ul class="collapse">
                            ...
                            <li class="<?php echo e(active_menu('admin-home/tax-certificates/settings')); ?>"><a
                    ...
                    <li class="main_dropdown <?php if(request()->is(['admin-home/reward/all','admin-home/reward/settings'])): ?> active <?php endif; ?>">
                        <a href="javascript:void(0)"
                           aria-expanded="true">
...
<?php /**PATH /Users/xgenious/Desktop/xgenious/localhost/fundorex-form-builder-client/@core/resources/views/backend/partials/sidebar.blade.php ENDPATH**/ ?>