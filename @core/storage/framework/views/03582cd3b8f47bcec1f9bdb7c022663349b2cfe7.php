...
<?php endif; ?>
                            ...
                            <div class="form-group">
                                <label for="navbar_button"><?php echo e(__('Show/Hide Donation Form Builder Data')); ?></label>
                                <label class="switch">
                                    <input type="checkbox" name="donation_form_builder_data_show_hide"
                                           <?php if(!empty(get_static_option('donation_form_builder_data_show_hide'))): ?> checked <?php endif; ?> >
                                    <span class="slider"></span>
                                </label>
                            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\xampp\htdocs\fundorex-form-builder-client\@core\resources\views/backend/donations/settings.blade.php ENDPATH**/ ?>