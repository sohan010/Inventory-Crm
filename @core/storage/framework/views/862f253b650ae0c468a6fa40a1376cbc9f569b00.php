        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('New Size Item')); ?></h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="input-group">
                            ...
                            <div class="parent my-3">
                                <label for="edit_name"><?php echo e(__('Size')); ?></label>
                                <div class="input-group">
                                    <div class="input-group-addon"><i class="ti-settings"></i></div>
                                    <input type="text" class="form-control" name="size_code" placeholder="<?php echo e(__('Size')); ?>">
                                </div>
                            </div>
...
<?php endif; ?><?php /**PATH H:\xampp\htdocs\inventory-crm\@core\resources\views/backend/popup-modals/size/add.blade.php ENDPATH**/ ?>