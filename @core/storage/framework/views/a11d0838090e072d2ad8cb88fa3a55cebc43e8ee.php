                                    ...
                                    <td>
                                        <?php if($data->default == 1): ?>
                                            <a href="javascript:void(0)"
                                               class="btn btn-lg btn-info btn-sm mb-3 mr-1"><?php echo e(__("Default")); ?></a>
                                        <?php else: ?>
...
<?php endif; ?>
                                        ...
                                        <a href="<?php echo e(route('admin.languages.words.frontend',$data->slug)); ?>"
                                           title="<?php echo e(__('Frontend Words')); ?>" class="btn btn-outline-info btn-xs mb-3 mr-1"
                                           >
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\xampp\htdocs\inventory-crm\@core\resources\views/backend/languages/index.blade.php ENDPATH**/ ?>