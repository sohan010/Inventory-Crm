            ...
            <div class="card-header" id="ssl_commerz_settings">
                <h5 class="mb-0">
                    <button class="btn btn-link" type="button"
                            ...
                            aria-expanded="false">
                        <span class="page-title"> <?php echo e(__('SSLCommerz Settings')); ?></span>
                    </button>
                </h5>
            </div>
            <div id="ssl_commerz_settings_content" class="collapse"
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <label for="paytm_gateway"><strong><?php echo e(__('Enable/Disable SSlCommerz')); ?></strong></label>
                        <label class="switch">
                            <input type="checkbox" name="ssl_commerz_gateway"
                                   <?php if(!empty(get_static_option('ssl_commerz_gateway'))): ?> checked
                                   <?php endif; ?> id="ssl_commerz_gateway">
                            <span class="slider onff"></span>
                        </label>
                    </div>
                    <div class="form-group">
                        <label for="paytm_test_mode"><strong><?php echo e(__('Enable Test Mode For SSlCommerz')); ?></strong></label>
                        <label class="switch">
                            <input type="checkbox" name="ssl_commerz_test_mode"
                                   <?php if(!empty(get_static_option('ssl_commerz_test_mode'))): ?> checked
                                    <?php endif; ?> >
                            <span class="slider onff"></span>
                        </label>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="paytm_merchant_key"><?php echo e(__('SSlCommerz Store ID')); ?></label>
                        <input type="text" name="ssl_commerz_store_id" id="zitopay_username" value="<?php echo e(get_static_option('ssl_commerz_store_id')); ?>" class="form-control">
                    </div>

                    <div class="form-group">
                        <label for="paytm_merchant_key"><?php echo e(__('SSlCommerz Store Password')); ?></label>
                        <input type="text" name="ssl_commerz_store_password" id="zitopay_username" value="<?php echo e(get_static_option('ssl_commerz_store_password')); ?>" class="form-control">
                    </div>
...
</div><?php /**PATH H:\xampp\htdocs\inventory-crm\@core\resources\views/backend/general-settings/gateway-portion/credentials.blade.php ENDPATH**/ ?>