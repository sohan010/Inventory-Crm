...
<div class="tab-area-new">
    ...
    <div id="tab-one" class="tab-content active">
        <div class="single-tabs">
            <?php if(get_static_option('donation_descriptions_show_hide')): ?>
            <div id="main-data">
                <?php echo Str::words(purify_html_raw(strip_tags($donation->cause_content)),70); ?>
...
</div><?php /**PATH /Users/xgenious/Desktop/xgenious/localhost/fundorex-form-builder-client/@core/resources/views/frontend/partials/donation-single/tab-view.blade.php ENDPATH**/ ?>