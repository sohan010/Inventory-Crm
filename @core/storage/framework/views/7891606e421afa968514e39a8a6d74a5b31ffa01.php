      ...
      <table class="table table-defaul" id="all_blog_table">
          ...
          <?php $__currentLoopData = $all_follower_donations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <tr>
                  <td>
                      <ul>
                          <li><strong><?php echo e(__('Followed Campaign Owner ')); ?>:</strong> <?php echo e($user->name); ?></li>
                      </ul>
                  </td>
                  <td>

                    <a <?php if(!empty($user->id)): ?> href="<?php echo e(route('frontend.user.created.donations',['user' => $data->created_by,'id' => $user->id ])); ?>" <?php endif; ?>
...
<?php echo $__env->make('frontend.user.dashboard.user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/xgenious/Desktop/xgenious/localhost/fundorex-with-api/@core/resources/views/frontend/user/dashboard/campaigns/following-user-campaigns.blade.php ENDPATH**/ ?>