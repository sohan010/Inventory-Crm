                  ...
                  <td>
                     <div class="campaign-image-wrap margin-bottom-25">
                      ...
                      <ul>
                          ...
                          <li><strong><?php echo e(__('Raised')); ?>:</strong> <?php echo e(amount_with_currency_symbol($data->raised)); ?></li>
                          <?php
                          ...
                          ?>
                          <li><strong><?php echo e(__('Withdraw')); ?>:</strong> <?php echo e(amount_with_currency_symbol($data->withdraws->where('payment_status' ,'!=', 'reject')->pluck('withdraw_request_amount')->sum())); ?></li>
                          <li><strong><?php echo e(__('Withdraw Pending')); ?>:</strong> <?php echo e(amount_with_currency_symbol($data->withdraws->where('payment_status' , 'pending')->pluck('withdraw_request_amount')->sum())); ?></li>
                          <li><strong><?php echo e(__('Available For Withdraw')); ?>:</strong> 
                            <?php 
                            ...
                            ?>
                          <?php echo e(amount_with_currency_symbol($available_withdraw)); ?> 
                          </li>
...
<?php echo $__env->make('frontend.user.dashboard.user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/xgenious/Desktop/xgenious/localhost/fundorex-with-api/@core/resources/views/frontend/user/dashboard/campaigns/all-campaigns.blade.php ENDPATH**/ ?>