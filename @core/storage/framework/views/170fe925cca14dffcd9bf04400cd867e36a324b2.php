        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('Edit Unit Item')); ?></h5>
                ...
                <form action="#" id="size_edit_modal_form" method="post"
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="id" id="unit_id" value="">
...
<?php endif; ?><?php /**PATH H:\xampp\htdocs\inventory-crm\@core\resources\views/backend/popup-modals/unit/edit.blade.php ENDPATH**/ ?>