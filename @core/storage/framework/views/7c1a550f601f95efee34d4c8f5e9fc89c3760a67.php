                        ...
                        <tr>
                            <td scope="row">
                                <div class="user-dahsboard-order-info-wrap">
                                    ...
                                    <?php
                                         $all_individual_fields = json_decode($data->individual_fields) ?? [];
                                          $all_company_fields = json_decode($data->company_fields) ?? [];
                                    ?>
                                         <small class="d-block text-primary"><?php echo e(__('Individual Fields : ')); ?></small>
                                        <?php $__currentLoopData = $all_individual_fields ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <small class="d-block"><strong class="text-dark "><?php echo e(ucfirst($key) . ' : '); ?></strong><?php echo e($field); ?></small>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                                        <small class="d-block text-info mt-3"><?php echo e(__('Company Fields : ')); ?></small>
                                        <?php $__currentLoopData = $all_company_fields ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <small class="d-block"><strong class="text-dark "><?php echo e(ucfirst($key) . ' : '); ?></strong><?php echo e($field); ?></small>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('frontend.user.dashboard.user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\xampp\htdocs\fundorex-form-builder-client\@core\resources\views/frontend/user/dashboard/donations.blade.php ENDPATH**/ ?>