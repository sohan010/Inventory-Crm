                    ...
                    <div class="modal-body">
                        ...
                        <div class="parent my-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="size_code" placeholder="<?php echo e(__('Size')); ?>" id="edit_size_code">
                            </div>
                        </div>
...
<?php endif; ?><?php /**PATH H:\xampp\htdocs\inventory-crm\@core\resources\views/backend/popup-modals/size/edit.blade.php ENDPATH**/ ?>