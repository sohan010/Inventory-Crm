<script src="<?php echo e(asset('assets/backend/xgenious/js/dropzone.js')); ?>"></script>
<script>
    (function ($) {
        "use strict";
       ...
       $(document).on('click','.media_library_image_delete_btn',function (e) {
            e.preventDefault();
            var el = $(this);
            el.children('i').removeClass('ti-trash').addClass('fa fa-spinner fa-spin');
            $.ajax({
                type: "POST",
...
<?php /**PATH H:\xampp\htdocs\inventory-crm\@core\resources\views/components/media/js.blade.php ENDPATH**/ ?>