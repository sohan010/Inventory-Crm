    ...
    <div class="modal fade" id="add_customer_modal_in_pos" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('admin.customer.ajax.store')); ?>" method="post" enctype="multipart/form-data" class="customer_add_form_pos">
...
<?php endif; ?>
                            ...
                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form-fields.select','data' => ['name' => 'customer_type','label' => ''.e(__('Customer Type')).'','col' => '12','customClass' => 'customer_type']]); ?>
<?php $component->withName('form-fields.select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'customer_type','label' => ''.e(__('Customer Type')).'','col' => '12','customClass' => 'customer_type']); ?>
...
<?php endif; ?>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary customer_add_form_pos_close_btn" data-dismiss="modal"><?php echo e(__('Close')); ?></button>
                            <button id="submit" type="submit" class="btn btn-info customer_submit_btn_from_pos"><?php echo e(__('Submit')); ?></button>
                        </div>
                    </div>
                </form>
            </div>
...
<?php /**PATH H:\xampp\htdocs\inventory-crm\@core\resources\views/backend/popup-modals/pos/add-customer.blade.php ENDPATH**/ ?>